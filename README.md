...
* 定制化  可定制化编译安装项目运行的生产环境 （<font color=red>安全</font>）。
* 自动化  配置检查好shell脚本后，一键自动化安装（自动）。
* 持续更新  定制配置和执行脚本持续更新，保证安全可用可持续（可持续）。
...
> **Git分享的是，环境安装的shell脚本，下面说明文档是，定制编译安装的步骤和方法**
...
Centos6稳定版平台（Centos6.5系统）持续更新中...）定制编译安装
===============================================
**测试环境服务**
