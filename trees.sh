...
downloadDepsSrc=1
checkDownload 2>&1 | tee -a ${TreesShell_dir}/install.log
...
case "${OS}" in
  "CentOS")
    installDepsCentOS 2>&1 | tee ${TreesShell_dir}/install.log
    ;;
  "Debian")
    installDepsDebian 2>&1 | tee ${TreesShell_dir}/install.log
    ;;
  "Ubuntu")
    installDepsUbuntu 2>&1 | tee ${TreesShell_dir}/install.log
    ;;
esac
...
case "${OS}" in
  "CentOS")
    . include/init_CentOS.sh 2>&1 | tee -a ${TreesShell_dir}/install.log
    [ -n "$(gcc --version | head -n1 | grep '4\.1\.')" ] && export CC="gcc44" CXX="g++44"
    ;;
  "Debian")
    . include/init_Debian.sh 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  "Ubuntu")
    . include/init_Ubuntu.sh 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
esac

# Install dependencies from source package
installDepsBySrc 2>&1 | tee -a ${TreesShell_dir}/install.log

# Jemalloc
if [[ ${nginx_option} =~ ^[1-3]$ ]] || [ "${db_yn}" == 'y' ]; then
  . include/jemalloc.sh
  Install_Jemalloc | tee -a ${TreesShell_dir}/install.log
fi

# openSSL
. ./include/openssl.sh
if [[ ${tomcat_option} =~ ^[1-3]$ ]] || [[ ${apache_option} =~ ^[1-2]$ ]] || [[ ${php_option} =~ ^[1-7]$ ]]; then
  Install_openSSL102 | tee -a ${TreesShell_dir}/install.log
fi
...
case "${db_option}" in
  1)
    if [ "${dbinstallmethod}" == "2" ]; then
      . include/boost.sh
      installBoost 2>&1 | tee -a ${TreesShell_dir}/install.log
    fi
    . include/mysql-5.7.sh
    Install_MySQL57 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  2)
    . include/mysql-5.6.sh
    Install_MySQL56 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  3)
    . include/mysql-5.5.sh
    Install_MySQL55 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  4)
    if [ "${dbinstallmethod}" == "2" ]; then
      . include/boost.sh
    ...
    Install_MariaDB102 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  5)
    if [ "${dbinstallmethod}" == "2" ]; then
      . include/boost.sh
    ...
    Install_MariaDB101 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  6)
    . include/mariadb-10.0.sh
    Install_MariaDB100 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  7)
    . include/mariadb-5.5.sh
    Install_MariaDB55 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  8)
    if [ "${dbinstallmethod}" == "2" ]; then
      . include/boost.sh
    ...
    Install_Percona57 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  9)
    . include/percona-5.6.sh
    Install_Percona56 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  10)
    . include/percona-5.5.sh
    Install_Percona55 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  11)
    . include/alisql-5.6.sh
    Install_AliSQL56 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  12)
    . include/postgresql.sh
    Install_PostgreSQL 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  13)
    . include/mongodb.sh
    Install_MongoDB 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
esac
...
if [ "${apache_option}" == '1' ]; then
  ...
  Install_Apache24 2>&1 | tee -a ${TreesShell_dir}/install.log
elif [ "${apache_option}" == '2' ]; then
  . include/apache-2.2.sh
  Install_Apache22 2>&1 | tee -a ${TreesShell_dir}/install.log
fi
...
case "${php_option}" in
  1)
    . include/php-5.3.sh
    Install_PHP53 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  2)
    . include/php-5.4.sh
    Install_PHP54 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  3)
    . include/php-5.5.sh
    Install_PHP55 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  4)
    . include/php-5.6.sh
    Install_PHP56 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  5)
    . include/php-7.0.sh
    Install_PHP70 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  6)
    . include/php-7.1.sh
    Install_PHP71 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  7)
    . include/php-7.2.sh
    Install_PHP72 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
esac
...
if [ "${db_option}" == '12' -a -e "${php_install_dir}/bin/phpize" ]; then
  ...
  Install_pecl-pgsql 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# pecl_mongodb
if [ "${db_option}" == '13' -a -e "${php_install_dir}/bin/phpize" ]; then
  . include/pecl_mongodb.sh
  Install_pecl-mongodb 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# ImageMagick or GraphicsMagick
if [ "${magick_option}" == '1' ]; then
  . include/ImageMagick.sh
  [ ! -d "/usr/local/imagemagick" ] && Install_ImageMagick 2>&1 | tee -a ${TreesShell_dir}/install.log
  [ ! -e "`${php_install_dir}/bin/php-config --extension-dir`/imagick.so" ] && Install_php-imagick 2>&1 | tee -a ${TreesShell_dir}/install.log
elif [ "${magick_option}" == '2' ]; then
  . include/GraphicsMagick.sh
  [ ! -d "/usr/local/graphicsmagick" ] && Install_GraphicsMagick 2>&1 | tee -a ${TreesShell_dir}/install.log
  [ ! -e "`${php_install_dir}/bin/php-config --extension-dir`/gmagick.so" ] && Install_php-gmagick 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# ionCube
if [ "${ioncube_yn}" == 'y' ]; then
  . include/ioncube.sh
  Install_ionCube 2>&1 | tee -a ${TreesShell_dir}/install.log
fi
...
case "${phpcache_option}" in
  1)
    if [[ "${php_option}" =~ ^[1,2]$ ]]; then
      ...
      Install_ZendOPcache 2>&1 | tee -a ${TreesShell_dir}/install.log
    fi
    ;;
  2)
    . include/xcache.sh
    Install_XCache 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  3)
    . include/apcu.sh
    Install_APCU 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  4)
    if [[ "${php_option}" =~ ^[1,2]$ ]]; then
      . include/eaccelerator.sh
      Install_eAccelerator 2>&1 | tee -a ${TreesShell_dir}/install.log
    fi
    ;;
esac
...
if [ "${zendguardloader_yn}" == 'y' ]; then
  ...
  Install_ZendGuardLoader 2>&1 | tee -a ${TreesShell_dir}/install.log
fi
...
case "${nginx_option}" in
  1)
    . include/nginx.sh
    Install_Nginx 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  2)
    . include/tengine.sh
    Install_Tengine 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  3)
    . include/openresty.sh
    Install_OpenResty 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
esac
...
case "${jdk_option}" in
  1)
    . include/jdk-1.8.sh
    Install-JDK18 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  2)
    . include/jdk-1.7.sh
    Install-JDK17 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  3)
    . include/jdk-1.6.sh
    Install-JDK16 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
esac
...
case "${tomcat_option}" in
  1)
    . include/tomcat-8.sh
    Install_Tomcat8 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  2)
    . include/tomcat-7.sh
    Install_Tomcat7 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
  3)
    . include/tomcat-6.sh
    Install_Tomcat6 2>&1 | tee -a ${TreesShell_dir}/install.log
    ;;
esac
...
if [ "${ftp_yn}" == 'y' ]; then
  . include/pureftpd.sh
  Install_PureFTPd 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# phpMyAdmin
if [ "${phpmyadmin_yn}" == 'y' ]; then
  . include/phpmyadmin.sh
  Install_phpMyAdmin 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# redis
if [ "${redis_yn}" == 'y' ]; then
  . include/redis.sh
  [ ! -d "${redis_install_dir}" ] && Install_redis-server 2>&1 | tee -a ${TreesShell_dir}/install.log
  [ -e "${php_install_dir}/bin/phpize" ] && [ ! -e "$(${php_install_dir}/bin/php-config --extension-dir)/redis.so" ] && Install_php-redis 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# memcached
if [ "${memcached_yn}" == 'y' ]; then
  . include/memcached.sh
  [ ! -d "${memcached_install_dir}/include/memcached" ] && Install_memcached 2>&1 | tee -a ${TreesShell_dir}/install.log
  [ -e "${php_install_dir}/bin/phpize" ] && [ ! -e "$(${php_install_dir}/bin/php-config --extension-dir)/memcache.so" ] && Install_php-memcache 2>&1 | tee -a ${TreesShell_dir}/install.log
  [ -e "${php_install_dir}/bin/phpize" ] && [ ! -e "$(${php_install_dir}/bin/php-config --extension-dir)/memcached.so" ] && Install_php-memcached 2>&1 | tee -a ${TreesShell_dir}/install.log
fi

# index example
if [ ! -e "${wwwroot_dir}/default/index.html" -a "${web_yn}" == 'y' ]; then
  . include/demo.sh
  DEMO 2>&1 | tee -a ${TreesShell_dir}/install.log
fi
...
if [ "${hhvm_yn}" == 'y' ] && [ "$OS" == 'CentOS' -a "$OS_BIT" == '64' ] && [ -n "`grep -E ' 7\.| 6\.[5-9]' /etc/redhat-release`" ]; then
  ...
  Install_hhvm_CentOS 2>&1 | tee -a ${TreesShell_dir}/install.log
fi
...
echo "Total TreesShell Install Time: ${CQUESTION}${installTime}${CEND} minutes"
